...
const YouTubeSummarizer = () => {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      const mockResult = `# ${outputTypes.find(t => t.value === outputType)?.label || 'Analysis'}

## Key Points:
• Main topic discussed with detailed explanations
• Important concepts and their practical applications  
• Notable quotes and insights from the content
• Action items and recommendations

## Summary:
This content covers essential aspects of the topic with comprehensive coverage of key concepts. The speaker provides valuable insights that can be applied in practical scenarios.

## Additional Notes:
- Content duration and complexity level assessed
